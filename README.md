...
```nix
inputs.network-link-recorder.url = "github:colinbdclark/network-link-recorder";
...
```console
nix run github:colinbdclark/network-link-recorder#network-link-recorder-client -- \
